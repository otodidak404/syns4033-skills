---
name: hacktricks-macos-ruby-applications-injection
description: >-
  Hacktricks playbook: macOS Ruby Applications Injection. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Ruby Applications Injection
