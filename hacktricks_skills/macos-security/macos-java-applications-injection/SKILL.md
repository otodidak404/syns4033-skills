---
name: hacktricks-macos-java-applications-injection
description: >-
  Hacktricks playbook: macOS Java Applications Injection. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Java Applications Injection
