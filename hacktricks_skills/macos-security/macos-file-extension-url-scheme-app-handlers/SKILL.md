---
name: hacktricks-macos-file-extension-url-scheme-app-handlers
description: >-
  Hacktricks playbook: macOS File Extension & URL scheme app handlers. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS File Extension & URL scheme app handlers
