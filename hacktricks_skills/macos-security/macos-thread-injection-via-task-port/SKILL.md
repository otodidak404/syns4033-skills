---
name: hacktricks-macos-thread-injection-via-task-port
description: >-
  Hacktricks playbook: macOS Thread Injection via Task port. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Thread Injection via Task port
