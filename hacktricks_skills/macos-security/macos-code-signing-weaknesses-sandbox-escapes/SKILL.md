---
name: hacktricks-macos-code-signing-weaknesses-sandbox-escapes
description: >-
  Hacktricks playbook: macOS Code Signing Weaknesses & Sandbox Escapes. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Code Signing Weaknesses & Sandbox Escapes
