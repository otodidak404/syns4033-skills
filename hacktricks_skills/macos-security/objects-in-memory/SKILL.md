---
name: hacktricks-objects-in-memory
description: >-
  Hacktricks playbook: Objects in memory. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Objects in memory
