---
name: hacktricks-introduction-to-x64
description: >-
  Hacktricks playbook: Introduction to x64. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Introduction to x64
