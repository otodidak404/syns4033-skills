---
name: hacktricks-macos-auto-start
description: >-
  Hacktricks playbook: macOS Auto Start. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Auto Start
