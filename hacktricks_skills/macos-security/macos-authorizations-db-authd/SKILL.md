---
name: hacktricks-macos-authorizations-db-authd
description: >-
  Hacktricks playbook: macOS Authorizations DB & Authd. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: macOS Authorizations DB & Authd
