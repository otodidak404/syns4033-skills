---
name: hacktricks-archive-extraction-path-traversal-zip-slip
description: >-
  Hacktricks guide for Archive Extraction Path Traversal ("Zip-Slip"). Covers exploitation techniques, enumeration methods, and remediation.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking, cybersecurity]
---

# Hacktricks: Archive Extraction Path Traversal ("Zip-Slip")
