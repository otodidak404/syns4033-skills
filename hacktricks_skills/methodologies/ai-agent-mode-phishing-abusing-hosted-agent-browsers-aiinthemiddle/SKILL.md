---
name: hacktricks-ai-agent-mode-phishing-abusing-hosted-agent-browsers-aiinthemiddle
description: >-
  Hacktricks playbook: AI Agent Mode Phishing: Abusing Hosted Agent Browsers (AI‑in‑the‑Middle). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: AI Agent Mode Phishing: Abusing Hosted Agent Browsers (AI‑in‑the‑Middle)
