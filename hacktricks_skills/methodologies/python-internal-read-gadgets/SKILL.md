---
name: hacktricks-python-internal-read-gadgets
description: >-
  Hacktricks playbook: Python Internal Read Gadgets. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Python Internal Read Gadgets
