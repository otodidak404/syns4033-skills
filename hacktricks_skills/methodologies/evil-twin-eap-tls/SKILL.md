---
name: hacktricks-evil-twin-eap-tls
description: >-
  Hacktricks playbook: Evil Twin EAP-TLS. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Evil Twin EAP-TLS
...
EAP drives an identity exchange *before* TLS starts. If the client uses the real domain username as its outer identity, anyone in RF range can harvest it without authenticating.<sup>[[1]](#references)</sup>
...
Key knobs from the Windows EAP-TLS profile:<sup>[[4]](#references)</sup>
...
Observed outcomes:<sup>[[1]](#references)</sup>
...
- [1] [EAP-TLS: The most secure option? (NCC Group)](https://www.nccgroup.com/research-blog/eap-tls-the-most-secure-option/)
- [2] [EAP-TLS wireless infrastructure (Versprite hostapd bypass)](https://versprite.com/blog/eap-tls-wireless-infrastructure/)
- [3] [RFC 4282 - Network Access Identifier](https://datatracker.ietf.org/doc/html/rfc4282)
- [4] [Microsoft ServerValidationParameters (WLAN profile)](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-gpwl/0765966e-a16a-4e75-aec6-0f5f7bfbf31c)
- [5] [RFC 9190 – EAP-TLS 1.3](https://datatracker.ietf.org/doc/rfc9190/)
- [6] [hostapd/wpa_supplicant 2.10 release notes (TLS 1.3 EAP-TLS support)](https://lists.infradead.org/pipermail/hostap/2022-February/040204.html)
- [7] [FreeRADIUS TLS 1.3 support thread (Nov 2024)](https://lists.freeradius.org/pipermail/freeradius-users/2024-November/104969.html)
- [8] [Windows 11 enabling TLS 1.3 for EAP (SecurityBoulevard, Jan 2024)](https://securityboulevard.com/2024/01/windows-11-changes-you-need-to-know/)
- [9] [EAP - What's changed in Windows 11 (Microsoft Learn)](https://learn.microsoft.com/en-us/windows-server/networking/technologies/extensible-authentication-protocol/windows-11-changes)
- [10] [Add Wi-Fi settings for Android devices in Microsoft Intune (Android Enterprise)](https://learn.microsoft.com/en-us/intune/device-configuration/templates/ref-wifi-settings-android-enterprise)
- [11] [Deprecating Obsolete Key Exchange Methods in (D)TLS 1.2 (IETF draft)](https://datatracker.ietf.org/doc/html/draft-ietf-tls-deprecate-obsolete-kex)
- [12] [SSL_CTX_set_security_level - OpenSSL Documentation](https://docs.openssl.org/3.0/man3/SSL_CTX_set_security_level/)
- [13] [ciphers - OpenSSL 1.1.1 Documentation](https://docs.openssl.org/1.1.1/man1/ciphers/)
