---
name: hacktricks-load-name-load-const-opcode-oob-read
description: >-
  Hacktricks playbook: LOAD_NAME / LOAD_CONST opcode OOB Read. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: LOAD_NAME / LOAD_CONST opcode OOB Read
