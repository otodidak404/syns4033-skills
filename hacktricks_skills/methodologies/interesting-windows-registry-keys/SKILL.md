---
name: hacktricks-interesting-windows-registry-keys
description: >-
  Hacktricks playbook: Interesting Windows Registry Keys. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Interesting Windows Registry Keys
