---
name: hacktricks-class-pollution-pythons-prototype-pollution
description: >-
  Hacktricks playbook: Class Pollution (Python's Prototype Pollution). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Class Pollution (Python's Prototype Pollution)
