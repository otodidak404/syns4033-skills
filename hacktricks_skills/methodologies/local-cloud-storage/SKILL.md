---
name: hacktricks-local-cloud-storage
description: >-
  Hacktricks playbook: Local Cloud Storage. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Local Cloud Storage
