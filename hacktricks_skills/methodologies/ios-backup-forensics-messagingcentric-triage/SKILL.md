---
name: hacktricks-ios-backup-forensics-messagingcentric-triage
description: >-
  Hacktricks playbook: iOS Backup Forensics (Messaging‑centric triage). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: iOS Backup Forensics (Messaging‑centric triage)
