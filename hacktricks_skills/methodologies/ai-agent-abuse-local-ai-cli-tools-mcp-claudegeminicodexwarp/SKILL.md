---
name: hacktricks-ai-agent-abuse-local-ai-cli-tools-mcp-claudegeminicodexwarp
description: >-
  Hacktricks playbook: AI Agent Abuse: Local AI CLI Tools & MCP (Claude/Gemini/Codex/Warp). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: AI Agent Abuse: Local AI CLI Tools & MCP (Claude/Gemini/Codex/Warp)
