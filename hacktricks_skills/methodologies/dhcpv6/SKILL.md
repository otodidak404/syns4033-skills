---
name: hacktricks-dhcpv6
description: >-
  Hacktricks playbook: DHCPv6. Exploitation techniques, enumeration, and attack patterns.
...
The following table compares DHCPv6 message types with their DHCPv4 counterparts.<sup>[[4]](#references)</sup>
...
The message roles are summarized below.<sup>[[5]](#references)</sup>
...
The THC-IPv6 information tool dumps available servers and their setup.<sup>[[3]](#references)</sup>

### Rogue DHCPv6 Server (Address/DNS Hijack)

The THC-IPv6 toolkit includes a fake DHCPv6 server that can configure an address and DNS server.<sup>[[3]](#references)</sup>
...
This is a generic on-link rogue DHCPv6 server. A related DHCPv6 DNS-takeover workflow uses IPv6-capable `ntlmrelayx` for WPAD and credential relaying; see [Pentesting IPv6](pentesting-ipv6.md).<sup>[[6]](#references)</sup>

### Pool Exhaustion / DHCPv6 Starvation

The THC-IPv6 toolkit also provides a DHCP client flooder intended to deplete a DHCPv6 server's address pool.<sup>[[3]](#references)</sup>
...
- [1] [Introduction to DHCPv6 Messages (Huawei Configuration Guide)](https://support.huawei.com/enterprise/en/doc/EDOC1100306163/d427e938/introduction-to-dhcpv6-messages)
- [2] [RFC 8415 - Dynamic Host Configuration Protocol for IPv6 (DHCPv6)](https://www.rfc-editor.org/rfc/rfc8415)
- [3] [THC-IPv6 | Kali Linux Tools](https://www.kali.org/tools/thc-ipv6/)
- [4] [DHCPv6 Snooping - Juniper Networks](https://www.juniper.net/documentation/us/en/software/nce/nce-509-campus-fabric-ip-clos-junos-os-cli-workflow/nce-509-campus-fabric-ip-clos-junos-os-cli-workflow.pdf)
- [5] [RFC 9915 - Dynamic Host Configuration Protocol for IPv6 (DHCPv6)](https://www.rfc-editor.org/rfc/rfc9915)
- [6] [dirkjanm/mitm6](https://github.com/dirkjanm/mitm6)
