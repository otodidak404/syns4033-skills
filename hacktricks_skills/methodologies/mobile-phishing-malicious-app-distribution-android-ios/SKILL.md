---
name: hacktricks-mobile-phishing-malicious-app-distribution-android-ios
description: >-
  Hacktricks playbook: Mobile Phishing & Malicious App Distribution (Android & iOS). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Mobile Phishing & Malicious App Distribution (Android & iOS)
