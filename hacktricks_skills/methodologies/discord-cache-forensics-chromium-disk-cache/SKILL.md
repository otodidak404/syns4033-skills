---
name: hacktricks-discord-cache-forensics-chromium-disk-cache
description: >-
  Hacktricks playbook: Discord Cache Forensics (Chromium Disk Cache). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Discord Cache Forensics (Chromium Disk Cache)
