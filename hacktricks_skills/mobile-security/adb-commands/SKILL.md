---
name: hacktricks-adb-commands
description: >-
  Hacktricks playbook: ADB Commands. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: ADB Commands
...
**Information obtained from:** [**http://adbshell.com/**](http://adbshell.com)<sup>[[1]](#references)</sup>
...
# -apk -- Include APKs from third-party applications
...
- [1] [ADB Shell - Android ADB Commands Manual](http://adbshell.com/)
