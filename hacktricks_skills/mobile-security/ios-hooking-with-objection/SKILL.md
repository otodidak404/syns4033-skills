---
name: hacktricks-ios-hooking-with-objection
description: >-
  Hacktricks playbook: iOS Hooking with Objection. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: iOS Hooking with Objection
...
For this section the tool [**Objection**](https://github.com/sensepost/objection) is going to be used.<sup>[[1]](#references)</sup>\
...
- `ios hooking watch method "-[<class_name> <method_name>]" --dump-args --dump-return --dump-backtrace`: Hook a specific class method and dump its arguments, return value, and backtrace each time it is called
