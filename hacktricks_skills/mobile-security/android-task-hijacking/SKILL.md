---
name: hacktricks-android-task-hijacking
description: >-
  Hacktricks playbook: Android Task Hijacking. Exploitation techniques, enumeration, and attack patterns.
...
4. The attacker’s UI is shown first.<sup>[[1]](#references)[[2]](#references)</sup>

### Default–Affinity (no `singleTask`) variant  – Caller ID case study

The vulnerability reported in the **Caller ID (caller.id.phone.number.block)** application shows that the attack *also* works against the default `standard` launch mode:<sup>[[3]](#references)</sup>
...
Developers should:<sup>[[4]](#references)</sup>
...
- [1] [A deep dive into Task Hijacking in Android](https://blog.dixitaditya.com/android-task-hijacking/)
- [2] [Android task hijacking using moveTaskToBack() and excludeFromRecents](https://blog.takemyhand.xyz/2021/02/android-task-hijacking-with.html)
- [3] [Android Manifest Misconfiguration Leading to Task Hijacking in Caller ID app](https://github.com/KMov-g/androidapps/blob/main/caller.id.phone.number.block.md)
- [4] [The Risk of Android StrandHogg Security Issue and How it can be Mitigated](https://medium.com/mobile-app-development-publication/the-risk-of-android-strandhogg-security-issue-and-how-it-can-be-mitigated-80d2ddb4af06)
- [5] [Promon – StrandHogg 2.0 (CVE-2020-0096) technical write-up](https://promon.io/resources/downloads/strandhogg-2-0-new-serious-android-vulnerability)
- [6] [USENIX 2025 – TapTrap: Animation-Driven Tapjacking on Android](https://www.usenix.org/conference/usenixsecurity25/presentation/beer)
