---
name: hacktricks-webview-protocol-handlers
description: >-
  Hacktricks playbook: WebView Protocol Handlers. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: WebView Protocol Handlers
...
Recent technique-focused lessons from 2024-2025 research and advisories:<sup>[[2]](#references)</sup>
...
- [1] [MASTG-TEST-0077: Testing WebView Protocol Handlers](https://mas.owasp.org/MASTG/tests/ios/MASVS-PLATFORM/MASTG-TEST-0077/)
- [2] [Bypass for CVE-2024-9956 in Safari on iOS](https://denniskniep.github.io/posts/13-bypass-cve-2024-9956/)
