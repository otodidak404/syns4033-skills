---
name: hacktricks-apk-decompilers
description: >-
  Hacktricks playbook: APK decompilers. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: APK decompilers
...
The comparative decompilation guide in the references provides further details on the tools and their tradeoffs.<sup>[[3]](#references)</sup>
...
**androidReverse** is an **on-device Android reverse-engineering suite**: useful when you need to triage an APK directly from a phone/tablet **without ADB or a desktop workstation**.<sup>[[1]](#references)</sup><sup>[[2]](#references)</sup>
