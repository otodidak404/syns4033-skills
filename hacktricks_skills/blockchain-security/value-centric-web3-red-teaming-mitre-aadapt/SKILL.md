---
name: hacktricks-value-centric-web3-red-teaming-mitre-aadapt
description: >-
  Hacktricks playbook: Value-Centric Web3 Red Teaming (MITRE AADAPT). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Value-Centric Web3 Red Teaming (MITRE AADAPT)
