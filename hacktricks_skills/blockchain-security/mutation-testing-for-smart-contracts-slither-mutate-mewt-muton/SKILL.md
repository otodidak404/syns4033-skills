---
name: hacktricks-mutation-testing-for-smart-contracts-slither-mutate-mewt-muton
description: >-
  Hacktricks playbook: Mutation Testing for Smart Contracts (slither-mutate, mewt, MuTON). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Mutation Testing for Smart Contracts (slither-mutate, mewt, MuTON)
