---
name: hacktricks-linux-environment-variables
description: >-
  Hacktricks playbook: Linux Environment Variables. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Linux Environment Variables
