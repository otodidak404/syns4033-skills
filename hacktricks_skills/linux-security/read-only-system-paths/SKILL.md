---
name: hacktricks-read-only-system-paths
description: >-
  Hacktricks playbook: Read-Only System Paths. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Read-Only System Paths
