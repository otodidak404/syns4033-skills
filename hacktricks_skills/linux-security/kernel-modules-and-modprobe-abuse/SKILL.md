---
name: hacktricks-kernel-modules-and-modprobe-abuse
description: >-
  Hacktricks playbook: Kernel Modules and modprobe Abuse. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Kernel Modules and modprobe Abuse
