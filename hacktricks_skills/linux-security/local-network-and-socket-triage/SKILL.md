---
name: hacktricks-local-network-and-socket-triage
description: >-
  Hacktricks playbook: Local Network and Socket Triage. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Local Network and Socket Triage
