---
name: hacktricks-payloads-to-execute
description: >-
  Hacktricks playbook: Payloads to execute. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Payloads to execute
