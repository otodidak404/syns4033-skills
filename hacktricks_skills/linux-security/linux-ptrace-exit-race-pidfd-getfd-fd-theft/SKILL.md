---
name: hacktricks-linux-ptrace-exit-race-pidfd-getfd-fd-theft
description: >-
  Hacktricks playbook: Linux ptrace exit-race `pidfd_getfd()` FD theft. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Linux ptrace exit-race `pidfd_getfd()` FD theft
