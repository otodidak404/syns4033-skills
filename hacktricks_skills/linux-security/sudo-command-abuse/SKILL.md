---
name: hacktricks-sudo-command-abuse
description: >-
  Hacktricks playbook: Sudo Command Abuse. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Sudo Command Abuse
