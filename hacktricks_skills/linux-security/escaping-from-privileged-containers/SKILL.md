---
name: hacktricks-escaping-from-privileged-containers
description: >-
  Hacktricks playbook: Escaping From `--privileged` Containers. Exploitation techniques, enumeration, and attack patterns.
