---
name: hacktricks-bootloader-testing
description: >-
  Hacktricks playbook: Bootloader Testing. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Bootloader Testing
