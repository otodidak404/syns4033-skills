---
name: hacktricks-escaping-from-kiosks
description: >-
  Hacktricks guide for Escaping from KIOSKs. Covers exploitation techniques, enumeration methods, and remediation.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking, cybersecurity]
---

# Hacktricks: Escaping from KIOSKs
