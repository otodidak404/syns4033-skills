---
name: hacktricks-mediatek-bl2-ext-secure-boot-bypass-el3-code-execution
description: >-
  Hacktricks playbook: MediaTek bl2_ext Secure-Boot Bypass (EL3 Code Execution). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: MediaTek bl2_ext Secure-Boot Bypass (EL3 Code Execution)
