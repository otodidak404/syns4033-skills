---
name: hacktricks-seimpersonate-from-high-to-system
description: >-
  Hacktricks playbook: SeImpersonate from High To System. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: SeImpersonate from High To System
