---
name: hacktricks-windows-c-payloads
description: >-
  Hacktricks playbook: Windows C Payloads. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Windows C Payloads
