---
name: hacktricks-from-high-integrity-to-system-with-name-pipes
description: >-
  Hacktricks playbook: From High Integrity to SYSTEM with Name Pipes. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: From High Integrity to SYSTEM with Name Pipes
