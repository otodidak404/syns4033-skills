---
name: hacktricks-local-ntlm-reflection-via-smb-arbitrary-port
description: >-
  Hacktricks playbook: Local NTLM Reflection via SMB Arbitrary Port. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Local NTLM Reflection via SMB Arbitrary Port
