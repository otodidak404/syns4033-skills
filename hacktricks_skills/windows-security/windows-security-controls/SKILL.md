---
name: hacktricks-windows-security-controls
description: >-
  Hacktricks guide for Windows Security Controls. Covers exploitation techniques, enumeration methods, and remediation.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking, cybersecurity]
---

# Hacktricks: Windows Security Controls
