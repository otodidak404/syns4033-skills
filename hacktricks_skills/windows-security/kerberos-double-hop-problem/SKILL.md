---
name: hacktricks-kerberos-double-hop-problem
description: >-
  Hacktricks playbook: Kerberos Double Hop Problem. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Kerberos Double Hop Problem
