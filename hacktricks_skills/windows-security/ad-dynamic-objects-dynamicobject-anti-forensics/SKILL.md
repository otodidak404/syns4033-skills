---
name: hacktricks-ad-dynamic-objects-dynamicobject-anti-forensics
description: >-
  Hacktricks playbook: AD Dynamic Objects (dynamicObject) Anti-Forensics. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: AD Dynamic Objects (dynamicObject) Anti-Forensics
