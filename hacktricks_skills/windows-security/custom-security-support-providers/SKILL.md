---
name: hacktricks-custom-security-support-providers
description: >-
  Hacktricks playbook: Custom Security Support Providers. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Custom Security Support Providers
