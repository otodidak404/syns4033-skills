---
name: hacktricks-privilege-escalation-with-autoruns
description: >-
  Hacktricks playbook: Privilege Escalation with Autoruns. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Privilege Escalation with Autoruns
