---
name: hacktricks-advanced-dll-side-loading-with-html-embedded-payload-staging
description: >-
  Hacktricks playbook: Advanced DLL Side-Loading With HTML-Embedded Payload Staging. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Advanced DLL Side-Loading With HTML-Embedded Payload Staging
