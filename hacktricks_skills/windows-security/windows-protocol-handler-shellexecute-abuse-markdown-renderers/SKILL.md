---
name: hacktricks-windows-protocol-handler-shellexecute-abuse-markdown-renderers
description: >-
  Hacktricks guide for Windows Protocol Handler / ShellExecute Abuse (Markdown Renderers). Covers exploitation techniques, enumeration methods, and remediation.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking, cybersecurity]
---

# Hacktricks: Windows Protocol Handler / ShellExecute Abuse (Markdown Renderers)
