---
name: hacktricks-writable-sys-path-dll-hijacking-privesc
description: >-
  Hacktricks playbook: Writable Sys Path +Dll Hijacking Privesc. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Writable Sys Path +Dll Hijacking Privesc
