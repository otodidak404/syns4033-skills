---
name: hacktricks-telephony-tapsrv-arbitrary-dword-write-to-rce-tapi-server-mode
description: >-
  Hacktricks playbook: Telephony tapsrv Arbitrary DWORD Write to RCE (TAPI Server Mode). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Telephony tapsrv Arbitrary DWORD Write to RCE (TAPI Server Mode)
