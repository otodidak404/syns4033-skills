---
name: hacktricks-active-directory-web-services-adws-enumeration-stealth-collection
description: >-
  Hacktricks playbook: Active Directory Web Services (ADWS) Enumeration & Stealth Collection. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Active Directory Web Services (ADWS) Enumeration & Stealth Collection
