---
name: hacktricks-windows-cpython-build-landmark-and-syspath-hijacking
description: >-
  Hacktricks playbook: Windows CPython Build-Landmark and `sys.path` Hijacking. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Windows CPython Build-Landmark and `sys.path` Hijacking
