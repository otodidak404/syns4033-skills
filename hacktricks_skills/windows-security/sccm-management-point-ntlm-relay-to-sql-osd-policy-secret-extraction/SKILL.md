---
name: hacktricks-sccm-management-point-ntlm-relay-to-sql-osd-policy-secret-extraction
description: >-
  Hacktricks playbook: SCCM Management Point NTLM Relay to SQL – OSD Policy Secret Extraction. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: SCCM Management Point NTLM Relay to SQL – OSD Policy Secret Extraction
