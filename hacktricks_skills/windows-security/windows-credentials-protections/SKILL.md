---
name: hacktricks-windows-credentials-protections
description: >-
  Hacktricks playbook: Windows Credentials Protections. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Windows Credentials Protections
