---
name: hacktricks-windows-kernel-eop-token-stealing-with-arbitrary-kernel-rw
description: >-
  Hacktricks playbook: Windows kernel EoP: Token stealing with arbitrary kernel R/W. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Windows kernel EoP: Token stealing with arbitrary kernel R/W
