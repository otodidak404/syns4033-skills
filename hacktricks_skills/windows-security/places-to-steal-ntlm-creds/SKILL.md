---
name: hacktricks-places-to-steal-ntlm-creds
description: >-
  Hacktricks playbook: Places to steal NTLM creds. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Places to steal NTLM creds
