---
name: hacktricks-creating-a-custom-action-msi-with-wix
description: >-
  Hacktricks playbook: Creating a Custom-Action MSI with WiX. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Creating a Custom-Action MSI with WiX
