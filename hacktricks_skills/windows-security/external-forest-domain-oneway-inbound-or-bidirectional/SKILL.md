---
name: hacktricks-external-forest-domain-oneway-inbound-or-bidirectional
description: >-
  Hacktricks playbook: External Forest Domain - OneWay (Inbound) or bidirectional. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: External Forest Domain - OneWay (Inbound) or bidirectional
