---
name: hacktricks-admin-protection-bypasses-via-uiaccess
description: >-
  Hacktricks playbook: Admin Protection Bypasses via UIAccess. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Admin Protection Bypasses via UIAccess
