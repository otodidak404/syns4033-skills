---
name: hacktricks-secure-desktop-accessibility-registry-propagation-lpe-regpwn
description: >-
  Hacktricks playbook: Secure Desktop Accessibility Registry Propagation LPE (RegPwn). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Secure Desktop Accessibility Registry Propagation LPE (RegPwn)
