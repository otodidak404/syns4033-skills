---
name: hacktricks-abusing-enterprise-auto-updaters-and-privileged-ipc-eg-netskope-asus-msi
description: >-
  Hacktricks playbook: Abusing Enterprise Auto-Updaters and Privileged IPC (e.g., Netskope, ASUS & MSI). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: Abusing Enterprise Auto-Updaters and Privileged IPC (e.g., Netskope, ASUS & MSI)
