---
name: hacktricks-printnightmare-windows-print-spooler-rcelpe
description: >-
  Hacktricks playbook: PrintNightmare (Windows Print Spooler RCE/LPE). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: PrintNightmare (Windows Print Spooler RCE/LPE)
