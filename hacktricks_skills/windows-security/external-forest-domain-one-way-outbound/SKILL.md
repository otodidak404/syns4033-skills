---
name: hacktricks-external-forest-domain-one-way-outbound
description: >-
  Hacktricks playbook: External Forest Domain - One-Way (Outbound). Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: External Forest Domain - One-Way (Outbound)
