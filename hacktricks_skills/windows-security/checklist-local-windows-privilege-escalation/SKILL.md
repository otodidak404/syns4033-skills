---
name: hacktricks-checklist-local-windows-privilege-escalation
description: >-
  Hacktricks guide for Checklist - Local Windows Privilege Escalation. Covers exploitation techniques, enumeration methods, and remediation.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking, cybersecurity]
---

# Hacktricks: Checklist - Local Windows Privilege Escalation
