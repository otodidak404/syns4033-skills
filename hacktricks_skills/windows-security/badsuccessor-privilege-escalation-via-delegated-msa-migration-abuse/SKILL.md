---
name: hacktricks-badsuccessor-privilege-escalation-via-delegated-msa-migration-abuse
description: >-
  Hacktricks playbook: BadSuccessor: Privilege Escalation via Delegated MSA Migration Abuse. Exploitation techniques, enumeration, and attack patterns.
source: https://book.hacktricks.xyz/
tags: [pentest, exploit, hacking]
---

# Hacktricks: BadSuccessor: Privilege Escalation via Delegated MSA Migration Abuse
